...
input_path_3 = '/mnt/d/Research/U2BenchmarkData/2DSquare_U2_tp-0.0_tpp0.0_beta16_mu1/'
input_path_4 = '/mnt/d/Research/U2BenchmarkData/2DSquare_U2_tp-0.0_tpp0.0_beta17_mu1/'
input_path_5 = '/mnt/d/Research/U2BenchmarkData/2DSquare_U2_tp-0.0_tpp0.0_beta20_mu1/'
w_dga_ed = []
sldga_n_ed = []
sldga_an_ed = []
...
w_dga_ed, sldga_n_ed, sldga_an_ed = append_dga_output(w_dga_ed, sldga_n_ed, sldga_an_ed,path=input_path_4+'LambdaDga_lc_sp_Nk4096_Nq4096_core30_invbse30_vurange30_wurange30/')
w_dga_ed, sldga_n_ed, sldga_an_ed = append_dga_output(w_dga_ed, sldga_n_ed, sldga_an_ed,path=input_path_3+'LambdaDga_lc_sp_Nk4096_Nq4096_core30_invbse30_vurange30_wurange30_2/')
w_dga_ed, sldga_n_ed, sldga_an_ed = append_dga_output(w_dga_ed, sldga_n_ed, sldga_an_ed,path=input_path_5+'LambdaDga_lc_sp_Nk4096_Nq4096_core30_invbse30_vurange30_wurange30/')
w_dga_ed, sldga_n_ed, sldga_an_ed = append_dga_output(w_dga_ed, sldga_n_ed, sldga_an_ed,path=input_path_3+'LambdaDga_lc_sp_Nk4096_Nq4096_core30_invbse30_vurange100_wurange30_1/')
w_dga_ed, sldga_n_ed, sldga_an_ed = append_dga_output(w_dga_ed, sldga_n_ed, sldga_an_ed,path=input_path_5+'LambdaDga_lc_spch_Nk4096_Nq4096_core30_invbse30_vurange30_wurange30/')
...
plt.savefig('DGA_sp_benchmark_b15_ctqmc.png')
plt.savefig('DGA_sp_benchmark_b15_ctqmc.pdf')
plt.tight_layout()
plt.show()
