...
g2_dens.plot(min(niw_g2//2,10), pdir=path, name=f'G2_dens')
g2_dens.plot(min(niw_g2,40), pdir=path, name=f'G2_dens')

g2_magn.plot(0, pdir=path, name='G2_magn')
g2_magn.plot(min(niw_g2//2,10), pdir=path, name=f'G2_magn')
g2_magn.plot(min(niw_g2,40), pdir=path, name=f'G2_magn')
