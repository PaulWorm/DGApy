...
def get_convergence_with_niv_shell(input_path, input_type, fname_1p, fname_2p, niv_shell_range, niv_core, niw_core):
    ...
    dga_config.type = input_type
    dga_config.fname_1p = fname_1p
    dga_config.fname_2p = fname_2p
    dga_config.box.niv_core = niv_core
    dga_config.box.niw_core = niw_core
    dmft_input = dga_io.load_1p_data(dga_config.type, dga_config.input_path, dga_config.fname_1p, dga_config.fname_2p)
    g2_dens, g2_magn = dga_io.build_g2_obj(dga_config.box, dmft_input)
    ...
    for niv_shell in niv_shell_range:
        dga_config.box.niv_shell = niv_shell
