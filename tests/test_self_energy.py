...
#     tmp = file['/dmft-last/ineq-001/giwk_obj/value'][()]
#     niv_cut = 30000
#     niv = np.shape(tmp)[-1]//2
#     del file['dmft-last/ineq-001/giwk_obj/value']
#     dset = file.create_dataset('dmft-last/ineq-001/giwk_obj/value', (1, 2,2*niv_cut),dtype=complex)
