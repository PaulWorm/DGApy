...
def test_greens_function_asymptotic_1():
    ...
    greens_function_asymptotic(ddict['giwk_obj'], ddict['siw'], ek, ddict['u'], ddict['n'], ddict['beta'], count=1)
...
def test_greens_function_asymptotic_2():
    ...
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    greens_function_asymptotic(ddict['giwk_obj'], ddict['siw'], ek, ddict['u'], ddict['n'], ddict['beta'], count=2)
...
def test_greens_function_asymptotic_3():
    ...
    k_grid = bz.KGrid(nk, bz.two_dimensional_square_symmetries())
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    greens_function_asymptotic(ddict['giwk_obj'], ddict['siw'], ek, ddict['u'], ddict['n'], ddict['beta'], count=3)
...
def test_greens_function_asymptotic_ed_1():
    ...
    k_grid = bz.KGrid(nk, bz.two_dimensional_square_symmetries())
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    greens_function_asymptotic(ddict['giwk_obj'], ddict['siw'], ek, ddict['u'], ddict['n'], ddict['beta'], count=4)
...
def test_local_dmft_consistency_1():
    ...
    k_grid = bz.KGrid(nk=nk, symmetries=bz.two_dimensional_square_symmetries())
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    local_dmft_consistency(ddict['giwk_obj'], ddict['siw'], ddict['mu'], ek, ddict['u'], ddict['n'], ddict['beta'], count=1)
...
def test_local_dmft_consistency_2():
    ...
    k_grid = bz.KGrid(nk=nk, symmetries=bz.two_dimensional_square_symmetries())
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    local_dmft_consistency(ddict['giwk_obj'], ddict['siw'], ddict['mu'], ek, ddict['u'], ddict['n'], ddict['beta'], count=2)
...
def test_local_dmft_consistency_3():
    ...
    k_grid = bz.KGrid(nk=nk, symmetries=bz.two_dimensional_square_symmetries())
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    local_dmft_consistency(ddict['giwk_obj'], ddict['siw'], ddict['mu'], ek, ddict['u'], ddict['n'], ddict['beta'], count=3)
...
def test_local_dmft_consistency_ed_1():
    ...
    k_grid = bz.KGrid(nk=nk, symmetries=bz.two_dimensional_square_symmetries())
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    local_dmft_consistency(ddict['giwk_obj'], ddict['siw'], ddict['mu'], ek, ddict['u'], ddict['n'], ddict['beta'], count=4)
...
def test_local_dmft_consistency_9():
    ...
    k_grid = bz.KGrid(nk=nk, symmetries=bz.two_dimensional_square_symmetries())
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    local_dmft_consistency(ddict['giwk_obj'], ddict['siw'], ddict['mu'], ek, ddict['u'], ddict['n'], ddict['beta'], count=9)
...
def test_greens_function_asymptotic_9():
    ...
    k_grid = bz.KGrid(nk, bz.two_dimensional_square_symmetries())
    ek = hamk.ek_3d(k_grid.grid, ddict['hr'])
    greens_function_asymptotic(ddict['giwk_obj'], ddict['siw'], ek, ddict['u'], ddict['n'], ddict['beta'], count=9)
